...
def gameOver(): # Game Over and Restart Game
    d = turtle.Turtle()
    d.up()
    d.ht()
    d.color("blue")
    d.write("GAME OVER\nScore : %04d\nClick to return to menu" % (len(snake_coor)), align="center", font=("Arial", 30, "bold"))
    
    SCREEN.onclick(lambda*a:[SCREEN.bye(),os.system("menusystem.py")])
